...
<head>
    ...
    <title>Candidate - Create new account</title>
    ...
    <form action="" id="validateForm" method="POST">
        ...
        <div class="container">
            <div class="row custom-row justify-content-start">
                <h2 class="head-text">Create new account as a Candidate</h2>
            </div>
                ...
                <div class="card main-container ">
                    <div class="card-body">
                        ...
                        <div class="form-row mt-2   ">
                            ...
                            <div class="form-label-group mt-0 mb-1 form-label-group-row col-6">
                                <input type="text" id="matrixNo" name="matrixNo" class="form-control custom-input" placeholder="Password" autofocus required />
                                <label for="matrixNo">Matrix Registration No.</label>
                            </div>
                        </div>
                        ...
                        <div class="form-row mt-4">
                            <div class="col align-self-center">
                                <div class="link-text mt-3">
                                    ...
                                    <a href="../../index.php" class="link-text-link"> Sign in </a>
                                </div>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $("#validateForm").validate({
                ...
                messages: {
                    ...
                    matrixNo: {
                        required: "Please enter your Matrix Registration number",
                    },
                    mFirstname: {
                ...
                submitHandler: function(form) {
                    $(function(){
                            ...
                            var nic             = $("#nicNo").val();
                            var matrixNo        = $("#matrixNo").val();
                            var cFirstName       = $("#mFirstname").val();
                            var cLastName       = $("#mLastname").val();
                            var cEmail          = $("#mEmail").val();
                            var cPhone          = $("#mPhone").val();
                            var cPassword        = $("#mPassword").val();
                        
                            event.preventDefault();
                        
                            $.ajax({
                                method                  : "POST",
                                url                     : "../../backend/php/cd-create-account.php",
                                data: {
                                    candidateNic          : nic,
                                    matrixNo              : matrixNo,
